...
/* -------------------------------------------------
   1. SPLASH – full‑screen, no overflow
   ------------------------------------------------- */
...
function SplashScreen({ onFadeOut }: SplashScreenProps) {
  ...
  useEffect(() => {
    ...
    vid.src = "/assets/B3TRBEACHSplashGif.mp4";
    vid.onloadeddata = () => setError(false);
    vid.onerror = () => setError(true);
...
/* -------------------------------------------------
   2. HEADER – 100 % width, 700 px tall, loops
   ------------------------------------------------- */
function Header() {
  const [error, setError] = useState(false);
...
/* -------------------------------------------------
   3. REST OF YOUR ORIGINAL SECTIONS
   ------------------------------------------------- */
function Hero() {
  return (
    <section
...
/* -------------------------------------------------
   4. FEATURES, SPONSORS, DOWNLOAD, FOOTER
   ------------------------------------------------- */
function Features() {
  return (
    <section
...
/* -------------------------------------------------
   5. MAIN COMPONENT – splash → full page
   ------------------------------------------------- */
