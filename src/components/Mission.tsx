  ...
  return (
    <>
      {/* ==== STATIONARY BACKGROUND ====
        This div is the fixed background that works on
        desktop and mobile.
      */}
      <div
      ...
      {/* ==== MAIN SCROLLING SECTION ====
        This section is for vertical scrolling.
        We removed all overflow properties from it.
      */}
      <section
        className="relative min-h-screen py-32 text-white"
      >
        {/* ==== NEW OVERFLOW FIX WRAPPER ====
          This new div's ONLY job is to clip the horizontal
          overflow from the animations. This fixes the
          mobile overflow bug without breaking scrolling.
        */}
        <div className="overflow-x-hidden">
          
          {/* ==== YOUR CONTENT CONTAINER ====
            This is your original container, now nested
            inside the overflow wrapper.
          */}
